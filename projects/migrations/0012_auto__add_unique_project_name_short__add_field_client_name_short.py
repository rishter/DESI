...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Project', fields ['name_short']
        db.create_unique('projects_project', ['name_short'])

        # Adding field 'Client.name_short'
        db.add_column('projects_client', 'name_short',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'Project', fields ['name_short']
        db.delete_unique('projects_project', ['name_short'])

        # Deleting field 'Client.name_short'
        db.delete_column('projects_client', 'name_short')
    ...
    models = {
        ...
        'projects.project': {
            ...
            'name_short': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'}),
