...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('projects_project', 'project_owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['projects.ProjectOwner']))

    def backwards(self, orm):

        # Changing field 'Project.project_owner'
        db.alter_column('projects_project', 'project_owner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['projects.ProjectOwner']))
